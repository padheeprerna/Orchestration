...
def generateAuditReport():
    ...
    htmlfile.write(
        ...
        'class="art-logo-name">Container Security Assessment Report</h1></div>')
    ...
    htmlfile.write(
        "<style>table, th, td {font-family: arial, sans-serif;border: 1px solid black;border-collapse: "
        "collapse;}tr:nth-child(even) {background-color: #E8E6E5;}</style>")
    ...
    # REPORT FOR INSPEC
    htmlfile.write(
        '<p styple=fon-weight:1000;"><left><b><h3 style="color:blue;"> 2. InSpec Host+Container Profile Report '
        '</h3></b></left></p>')
    htmlfile.write(
        "<style>table, th, td {font-family: arial, sans-serif;border: 1px solid black;border-collapse: "
        "collapse;}tr:nth-child(even) {background-color: #E8E6E5;}</style>")
